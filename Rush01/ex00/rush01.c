...
/*   Updated: 2024/07/07 14:28:14 by inajah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_isvalid_row(int c, int dir, int rule_index)
{
	int count_maxs;
	int max;
	int r;
...
int	ft_isvalid_col(int r, int dir, int rule_index)
{
	int count_maxs;
	int max;
	int c;
